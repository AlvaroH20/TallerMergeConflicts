...
const colores = ['lightgreen', 'lightblue', 'lightcoral', 'lightyellow', 'lightpink'];
...
export const Product = ({ navigation }) => {
    ...
    let ItemProducto = (props) => {
        const colorFondo = colores[props.indice % colores.length];
        return (
            <View style={[styles.itemProductos, { backgroundColor: colorFondo }]}>
    ...
    return <View style={styles.container}>
        <Text>Bienvenidos a mi tienda, soy Jordan </Text>
        <Button
            title='HOME'
            onPress={() => {
                navigation.navigate('WellcomeJORDAN');
            }}
        />
